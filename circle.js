class Vehicle{
    ...
    display(){
        ...
        if (this.color == 0){
            ...
            ellipse(this.position.x,(67-array_band2[99]-this.botz*(-array_band2[99]-array_band2[0])*0.3)*s_y,5)
        } else {
             //hole
        noFill();
        stroke(125, 241, 148,  100); //green
        strokeWeight(1);
        ellipse(this.position.x,145*s_y+this.botz*(-array_band2[99]-array_band2[0])*0.3,5)
        }
